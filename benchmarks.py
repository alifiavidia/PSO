...
def F24(x):
    ...
    z = ((x1-3.92)*(660)*(1/(1+(2.718282**(0.5*(x1-4.65)))))*(2.718282**(x1+2.4)))/(((1/(1+(2.718282**(0.5*(x1-4.65)))))*(2.718282**(x1+2.4)))+((1/(1+(2.718282**(0.5*(x2-4.65)))))*(2.718282**(x2+1.6)))+(47.16728)) + penalty1 + penalty2 + penalty3 + penalty4
